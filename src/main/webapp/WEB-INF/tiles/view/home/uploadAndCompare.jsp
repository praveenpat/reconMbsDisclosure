...
<div class="row">
    <div class="col-md-12">
	    ...
	    <form:form class="form-horizontal" method="post"
                modelAttribute="cusipRequest" action="/uploadFile" enctype="multipart/form-data">
		        ...
		        <div class="form-group">
                    <form:label class="col-sm-2 control-label" for="fileData" path="fileData">Upload CSV File</form:label><br/>
                    
                    <div class="col-sm-2">
                    <form:input class="btn btn-info" path="fileData" type="file"/>
                    </div>
               </div>
